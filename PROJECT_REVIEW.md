...
- Nhóm Critical/High đã xử lý xong REVIEW-001 đến REVIEW-007 và REVIEW-010; REVIEW-008/009/011 chưa triển khai.
- REVIEW-006/007 đã resolved ở phiên 53; REVIEW-010 resolved ở phiên 54. Các nhóm đều có build và service/concurrency smoke database tạm pass, database tạm được drop trong `finally`.
