...
- Nhóm Critical/High đã xử lý xong REVIEW-001 đến REVIEW-007 và REVIEW-010/011; REVIEW-008/009 chưa triển khai.
- REVIEW-006/007 resolved ở phiên 53, REVIEW-010 ở phiên 54 và REVIEW-011 ở phiên 55. Các nhóm đều có build và service/concurrency smoke database tạm pass, database tạm được drop trong `finally`.
